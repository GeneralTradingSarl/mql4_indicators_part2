   ...
   if (Show_LABELS==true)
     {
        ...
        {  
         ObjectMove("HILO2", 0, Time[Shift_CurrWeekly_LABEL], WHigh);
        }
        ...
        {  
         ObjectMove("HILO3", 0, Time[Shift_CurrWeekly_LABEL], WLow);
        }
        ...
        {  
         ObjectMove("HILO4", 0, Time[Shift_CurrMonthly_LABEL], MHigh);
        }
        ...
        {  
         ObjectMove("HILO5", 0, Time[Shift_CurrMonthly_LABEL], MLow);
        }
      //Previous Levels
        ...
        {  
         ObjectMove("HILOP", 0, Time[Shift_Prev_LABEL+10], DHi);
        }
        ...
        {  
         ObjectMove("HILO1P", 0, Time[Shift_Prev_LABEL+10], DLo);
        }
        ...
        {  
         ObjectMove("HILO3P", 0, Time[Shift_Prev_LABEL+10], WLo);
        }
        ...
        {  
         ObjectMove("HILO4P", 0, Time[Shift_Prev_LABEL+10], MHi);
        }
        ...
        {  
         ObjectMove("HILO5P", 0, Time[Shift_Prev_LABEL+10], MLo);
        }
      if (Show_Daily_Pivots==true)
        {
           ...
           {  
            ObjectMove("PIVOTD", 0, Time[ShiftPivot_LABELS+0], PD);
           }
        }
      if (Show_Weekly_Pivots==true)
        {
           ...
           {  
            ObjectMove("PIVOTW", 0, Time[ShiftPivot_LABELS+0], PW);
           }
        }
      if (Show_Monthly_Pivots==true)
        {
           ...
           {  
            ObjectMove("PIVOTM", 0, Time[ShiftPivot_LABELS+0], PM);
           }
        }
     }
   return(0);
