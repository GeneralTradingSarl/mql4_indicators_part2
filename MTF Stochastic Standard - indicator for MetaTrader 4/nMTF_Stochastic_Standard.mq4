...
extern bool Show_STOCH_2=false;
...
extern bool Show_STOCH_3=false;
...
//---- indicator line
   ...
   SetIndexLabel(0,"MAIN #1  ( "+(string)K_period1+" )( "+(string)D_period1+" )( "+(string)S_period1+" )");
   SetIndexBuffer(1,SignalBuffer1);
   SetIndexStyle(1,Show_STOCH_1 ,STOCH_SIGNAL_Line_Style1);
   SetIndexLabel(1,"SIGNAL #1 ( "+(string)K_period1+" )( "+(string)D_period1+" )( "+(string)S_period1+" )");
//----
...
//----
   ...
   SetIndexLabel(4,"MAIN #3 ( "+(string)K_period3+" )( "+(string)D_period3+" )( "+(string)S_period3+" )");
   SetIndexBuffer(5,SignalBuffer3);
   SetIndexStyle(5,Show_STOCH_3 ,STOCH_SIGNAL_Line_Style3);
   SetIndexLabel(5,"SIGNAL #3 ( "+(string)K_period3+" )( "+(string)D_period3+" )( "+(string)S_period3+" )");
//----
   ...
   SetIndexLabel(6,"MAIN #4 ( "+(string)K_period4+" )( "+(string)D_period4+" )( "+(string)S_period4+" )");
   SetIndexBuffer(7,SignalBuffer4);
   SetIndexStyle(7,Show_STOCH_4 ,STOCH_SIGNAL_Line_Style4);
   SetIndexLabel(7,"SIGNAL #4 ( "+(string)K_period4+" )( "+(string)D_period4+" )( "+(string)S_period4+" )");
...
//----
     if(Show_StochLabels==true)
     {
      ...
      ObjectSetText("stoLABEL","STOCH #1 :  "+(string)K_period1+" "+(string)D_period1+" "+(string)S_period1+"  "+STF1+"", 9, "Tahoma Narrow", indicator_color1);
...
//----
      ...
      ObjectSetText("stoLABEL1","STOCH #2 :  "+(string)K_period2+" "+(string)D_period2+" "+(string)S_period1+"  "+STF2+"", 9, "Tahoma Narrow", indicator_color3);
...
//----
      ...
      ObjectSetText("stoLABEL2","STOCH #3 :  "+(string)K_period3+" "+(string)D_period3+" "+(string)S_period1+"  "+STF3+"", 9, "Tahoma Narrow", indicator_color5);
...
//----
      ...
      ObjectSetText("stoLABEL4","STOCH #4 :  "+(string)K_period4+" "+(string)D_period4+" "+(string)S_period1+"  "+STF4+"", 9, "Tahoma Narrow", indicator_color7);
