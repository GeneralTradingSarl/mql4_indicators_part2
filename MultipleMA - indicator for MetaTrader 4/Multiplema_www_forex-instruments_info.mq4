...
//---- check for possible errors
   ...
   if(counted_bars==0) limit-=1+FirstMA_Period;
//----
   for(i=limit; i>=0; i--)
      if(FirstMA_Mode==4)
        {
   ...
   for(i=limit; i>=0; i--)
      MA2[i]=iMAOnArray(MA1,0,SecondMA_Period,0,SecondMA_Mode,i);
   for(i=limit; i>=0; i--)
      MA3[i]=iMAOnArray(MA2,0,ThirdMA_Period,0,ThirdMA_Mode,i);
//---- done
   return(0);
  }
//+------------------------------------------------------------------+
