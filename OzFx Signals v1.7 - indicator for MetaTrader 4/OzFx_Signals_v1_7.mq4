   ...
   for(k=0;k<count;k++)
     {
      ...
      ObjectSetText("OZFXREG"+k,ozfxRegPairs[k]  ,8, "Arial", Black);
      ...
      for(k=0;k<count;k++)
        {
         ...
         ObjectSetText("OZFXAES"+k, aesPairs[k] ,8, "Arial", Black);
      ...
      for(k=0;k<count;k++)
        {
         ...
         ObjectSetText("OZFXSM"+k,sqzmorePairs[k] ,8, "Arial", Black);
