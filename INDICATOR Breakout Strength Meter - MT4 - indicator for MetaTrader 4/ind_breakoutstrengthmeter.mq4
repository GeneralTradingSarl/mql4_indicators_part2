...
int OnCalculate(const int rates_total,
                ...
                const int &spread[])
 {
   ...
   vSetLabel("BSMBorderUp",0,25,20,cFontClr,8,"==============");
   vSetLabel("BSMTimeFrame",0,45,20,cFontClr,8,"Breakout Strength Meter | Timeframe is "+GetTimeFrame(Period()));
   vSetLabel("BSMBorderDown",0,65,20,cFontClr,8,"==============");
