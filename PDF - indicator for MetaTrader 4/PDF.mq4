...
//---- indicators
   ...
   for(i=limit;i>=0;i--)
     {
      value=(int)MathCeil(iStochastic(NULL,0,ch_size,2,1,MODE_SMA,0,MODE_MAIN,i));
      if(value!=0) counter[100-value]=counter[100-value]+1;
      //if(counter[100-value]>limit_value && limit_value!=0)counter[100-value]=limit_value;
     }
   pdf[0]=0;
   int limit2=100;
   if(limit2>Bars) limit2=Bars;
