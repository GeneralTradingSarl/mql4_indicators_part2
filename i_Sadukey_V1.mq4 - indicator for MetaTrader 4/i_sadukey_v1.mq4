...
//|                                                     sadukey@ya.ru|
//+------------------------------------------------------------------+
#property copyright "Concept by SADUKEY "
#property link      "sadukey@ya.ru"
...
Buffer1[shift]= NormalizeDouble(Buffer1[shift],period);
Buffer2[shift]= NormalizeDouble(Buffer2[shift],period);
